...
/***/ function(module, exports, __webpack_require__) {
	...
	var MenuComponent = (function (_React$Component) {
	  ...
	  function MenuComponent() {
	    ...
	    // 親を呼び出す
	    _get(Object.getPrototypeOf(MenuComponent.prototype), 'constructor', this).call(this);
	  ...
	  _createClass(MenuComponent, [{
	    ...
	    value: function generateStyleObject(keys, propery) {
	      var obj = {};
	    ...
	    key: 'prepareBtnStyles',
	    value: function prepareBtnStyles() {
	      var _btnStyles;

	      var transitionKeys = ['transition', 'msTransition', 'MozTransition', 'OTransition', 'WebkitTransition'];
	      var transformKeys = ['transform', 'msTransform', 'MozTransform', 'Otransform', 'WebkitTransform'];

	      //アニメーションの基本スタイル
	      var animationBase = this.generateStyleObject(transitionKeys, 'all cubic-bezier(0.1, 0.9, 0.1, 1) 0.6s');

	      // 1回目にクリックした時にかける追加スタイル
	      var modifier1 = this.generateStyleObject(transformKeys, 'translate3d(-100px, 0, 0)');
	      // 2回目にクリックした時にかける追加スタイル
	      var modifier2 = this.generateStyleObject(transformKeys, 'translate3d(0, -100px, 0)');
	      // 3回目にクリックした時にかける追加スタイル
	      var modifier3 = this.generateStyleObject(transformKeys, 'translate3d(100px, 0, 0)');
	      ...
	      var objIdx = 1;
	      var OBJ_NAME = 'btnStyleParentEnterActive';

	      // 各ボタンのスタイルをまとめたオブジェクト
	      this.btnStyles = (_btnStyles = {}, _defineProperty(_btnStyles, OBJ_NAME + objIdx++, (0, _objectAssign2['default'])({}, animationBase, styleBase, {
	        backgroundColor: '#009688'
	      })), _defineProperty(_btnStyles, OBJ_NAME + objIdx++, (0, _objectAssign2['default'])({}, animationBase, modifier1, styleBase, {
	        backgroundColor: '#1A237E'
	      })), _defineProperty(_btnStyles, OBJ_NAME + objIdx++, (0, _objectAssign2['default'])({}, animationBase, modifier2, styleBase, {
	        backgroundColor: '#D50000'
	      })), _defineProperty(_btnStyles, OBJ_NAME + objIdx++, (0, _objectAssign2['default'])({}, animationBase, modifier3, styleBase, {
	        backgroundColor: '#37474F'
	      })), _defineProperty(_btnStyles, 'btnStyleChild', {
	        color: '#F1F1F1',
	        fontWeight: 'bold'
	      }), _btnStyles);
	    ...
	    value: function render() {
	      ...
	      */
	      return _react2['default'].createElement(
	        'div',
	        { style: this.state.btnStyle, onClick: this.updateBtnStyle.bind(this) },
	        _react2['default'].createElement(
	          'a',
	          { style: this.state.btnTextStyle },
	          'Click Me!'
	        )
	      );
	    }
	...
	// コンポーネントを指定
	_react2['default'].createElement(MenuComponent, null),
	// コンポーネントの親DOMを指定
